...
###########################################
def Baseline_model(X_tr, X_cv, y_tr, y_cv,X_tr, X_test, y_tr, y_test):
...
def Gene_only_model(X_tr, X_cv, y_tr, y_cv,X_tr, X_test, y_tr, y_test):
...
def variation_only_model(X_tr, X_cv, y_tr, y_cv,X_tr, X_test, y_tr, y_test):
